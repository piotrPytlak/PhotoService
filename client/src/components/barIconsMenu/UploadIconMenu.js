...
export default function UploadIconMenu(props) {
  ...
  const onOpenDialogMenuHandlerAlbum = useCallback(
    () => setAlbumDialogIsOpen(true),
    [setAlbumDialogIsOpen]
  );
  const onCloseDialogMenuHandlerAlbum = useCallback(
    () => setAlbumDialogIsOpen(false),
    [setAlbumDialogIsOpen]
  );

  const [photoDialogIsOpen, setPhotoDialogIsOpen] = useState(false);
  const onOpenDialogMenuHandlerPhoto = useCallback(
    () => setPhotoDialogIsOpen(true),
    [setPhotoDialogIsOpen]
  );
  const onCloseDialogMenuHandlerPhoto = useCallback(
    () => setPhotoDialogIsOpen(false),
    [setPhotoDialogIsOpen]
  );
